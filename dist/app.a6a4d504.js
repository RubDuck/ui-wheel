...
!function (i) {
  ...
  !function (t) {
    ...
    } else document.attachEvent && (a = t, e = i.document, o = !1, l = function l() {
      o || (o = !0, a());
    }, (_n = function n() {
      try {
...
exports.default = _default;
        var $35e430 = exports.default || module.exports;
      
      if (typeof $35e430 === 'function') {
        $35e430 = $35e430.options;
      }
    
        /* template */
        Object.assign($35e430, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.ok
        ? [_c("g-icon", { staticClass: "icon-ok", attrs: { name: "ok" } })]
        : _vm._e()
    ],
    2
  )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$35e430', $35e430);
          } else {
            api.reload('$35e430', $35e430);
          }
        }
